...
4) echo "Iniciando processo, aguarde..."; chmod a+x scripts/create_system_new.sh && ./scripts/create_system_new.sh && chmod a+x scripts/create_product_new.sh && ./scripts/create_product_new.sh && chmod a+x scripts/create_vendor_new.sh && ./scripts/create_vendor_new.sh && echo "Concluído!" ;;
5) echo "Iniciando processo, aguarde..."; chmod a+x scripts/optimize_system.sh && ./scripts/optimize_system.sh && chmod a+x scripts/optimize_product.sh && ./scripts/optimize_product.sh && chmod a+x scripts/optimize_vendor.sh && ./scripts/optimize_vendor.sh && echo "Concluído!" ;;
6) echo "Iniciando processo, aguarde..."; chmod a+x scripts/create_system_new.sh && ./scripts/create_system_new.sh && chmod a+x scripts/create_system_ext_new.sh && ./scripts/create_system_ext_new.sh && chmod a+x scripts/create_product_new.sh && ./scripts/create_product_new.sh && chmod a+x scripts/create_vendor_new.sh && ./scripts/create_vendor_new.sh && echo "Concluído!" ;;
7) echo "Iniciando processo, aguarde..."; chmod a+x scripts/optimize_system.sh && ./scripts/optimize_system.sh && chmod a+x scripts/optimize_system_ext.sh && ./scripts/optimize_system_ext.sh && chmod a+x scripts/optimize_product.sh && ./scripts/optimize_product.sh && chmod a+x scripts/optimize_vendor.sh && ./scripts/optimize_vendor.sh && echo "Concluído!" ;;
