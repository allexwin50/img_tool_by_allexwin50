...
echo "#  [4m] mods.img para samsung M62                                #"
echo "#  [5f] mods.img para samsung F62                                #"
echo "#                       ------------------                       #"
...
4m) echo "Iniciando processo, aguarde..."; ./scripts/sincronize_samsung_m62.sh  && echo "Concluído!" ;;
5f) echo "Iniciando processo, aguarde..."; ./scripts/sincronize_samsung_f62.sh  && echo "Concluído!" ;;
6) clear && ./MAKE.sh ;;
